...
.list-group-item {
    ...
    padding: 10px 15px;
    font-size: 16px;
    border: 1rem; /* Menghilangkan garis pembatas antar item */
}
...
.list-group-item.border-bottom {
  border-bottom: 1px solid rgba(0, 0, 0, .125); /* Ganti warna sesuai kebutuhan */
}
                          ...
                          <div class="tab-pane fade show active" id="datadiri">
                              <form class="form-horizontal" action="{{ route('profile.update') }}" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="col-12 text-center">
                                      <button type="submit" class="btn btn-sm btn-outline-success">Perbaharui</button>
                                  </div>
                              </form>
                          </div>
                          ...
                          <div class="tab-pane fade" id="sandi">
                              <form class="form-horizontal" action="{{ route('password.update') }}" method="post">
                                  ...
                                  <div class="form-group row mb-3">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="password" class="form-control" name="sbaru_confirmation" required>
                                      </div>
                                  </div>
                                  <hr>
                                  <div class="col-12 text-center">
                                      <button type="submit" class="btn btn-sm btn-outline-success">Ubah Kata Sandi</button>
                                  </div>
                              </form>
                          </div>
                      </div>
