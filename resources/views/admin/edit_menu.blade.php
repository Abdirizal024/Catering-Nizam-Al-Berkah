    ...
    <div class="col-md-7"> 
        <div class="card card-primary card-outline mb-4"> 
            ...
            <form action="{{ route('menu.update', $menu->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
              @method('PUT') <!-- Mengubah metode HTTP menjadi PUT untuk update -->
              ...
              <div class="card-body">
                  ...
                  <div class="mb-3">
                      ...
                      <input type="text" name="nama" class="form-control" id="nama" 
                             value="{{ old('nama', $menu->nama) }}" placeholder="Masukkan Nama Menu" required>
                  </div>
                  ...
                  <div class="mb-3">
                      ...
                      <textarea name="deskripsi" class="form-control" id="deskripsi" 
                                placeholder="Masukkan Rincian Menu" required>{{ old('deskripsi', $menu->deskripsi) }}</textarea>
                  </div>
                  ...
                  <div class="mb-3">
                      ...
                      <input type="number" name="harga" class="form-control" id="harga" 
                             value="{{ old('harga', $menu->harga) }}" placeholder="Masukkan Harga" required>
                  </div>
    
                  <!-- Gambar -->
                  <div class="mb-3">
                      <label for="current_gambar" class="form-label">Gambar Saat Ini</label><br>
                      <img src="{{ asset('storage/' . $menu->gambar) }}" alt="Gambar Menu" width="150px">
                  </div>
    
                  <!-- Upload Gambar Baru -->
                  <div class="input-group mb-3">
                      <input type="file" name="gambar" class="form-control" id="gambar">
                      <label class="input-group-text" for="gambar">Upload Gambar (Opsional)</label>
                  </div>
              </div>
              <!-- End Body -->
