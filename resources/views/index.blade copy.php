...
<section class="ftco-section ftco-wrap-about ftco-no-pb ftco-no-pt">
			...
			<div class="row">
				<div class="col-md-6 col-lg-4">
                    ...
                    <p><span>Meat</span>, <span>Potatoes</span>, <span>Rice</span>, <span>Tomatoe</span></p>
                                                <!-- Harga dalam Rupiah di bawah judul -->
												<div class="one-forth">
                            <!-- Harga di samping nama menu -->
                            <span class="price mb-2 d-block" style="white-space: nowrap;">Rp 29.000</span>
                        </div>
					<!-- Tombol Checkout -->
	...
	<section class="ftco-section bg-light">
		<div class="container">
			...
			<div class="col-md-12">
				<h3 class="text-center mb-4">Our Catering Location</h3>
				<!-- Map Container -->
				<div class="card-body">
                    <iframe
